...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { name: @bet.name, references: @bet.references, user_id: @bet.user_id, wager: @bet.wager } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { name: @bet.name, references: @bet.references, user_id: @bet.user_id, wager: @bet.wager } }
