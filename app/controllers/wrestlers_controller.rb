class WrestlersController < ApplicationController
  ...
  def destroy
    @wrestler.destroy
    respond_to do |format|
      format.html { redirect_to wrestlers_url, notice: 'Wrestler was successfully destroyed.' }
  ...
  private
    ...
    def wrestler_params
      params.require(:wrestler).permit(:name, :college_id, :college_year, :bio, :avatar)
    end
end
